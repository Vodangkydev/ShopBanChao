            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Chọn món cháo</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Chọn loại cháo</a></li>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" > <?php echo $product['price']." VNĐ" ;?></span> 
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Thêm" />
										</div>
										</form>
                                    </div>   
                                </div>
