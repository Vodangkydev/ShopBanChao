        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Cháo ngon mỗi ngày tốt cho sức khỏe </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Chọn loại cháo</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Ăn tại chỗ hoặc mang về</h4> </div>
                    </div>
                </div>
            </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Bán chạy</h2>
                    <p class="lead">Cháu ngon mỗi ngày, chọn món cháo bạn yêu thích</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">VNĐ: '.$r ['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Thêm vào giỏ hàng</a> </div>
                                                </div>
...
<html>
  ...
  <body>
    ...
    <script>
      function initMap() {
        var mapOptions = {
          center: new google.maps.LatLng(10.792697715583676, 106.6970830502464), // Tọa độ của trung tâm Hồ Chí Minh
